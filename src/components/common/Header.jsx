    ...
    <>
      <header>
        ...
        >
          ...
          ${headerSticky && 'header-sticky'} ${homeNine &&
              'header-transparent border-0'}`}
            id='header-sticky'
          >
            <div
              className={`${
            ...
            >
              <div className='row align-items-center justify-content-between'>
                <div
                  className='col-xxl-3 col-xl-2 col-lg-2 col-md-6 col-6'
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                ...
                >
                    <div className='logo-dark' style={{ padding: '.25rem' }}>
                      <Link href='/'>
                        <a>
                          {homeNine ? (
                            <Image
                              height={imageSize}
                              width={imageSize}
                              src='/assets/img/maria/just_loan_solutions_logo.png'
                              alt='logo'
                            />
                          ) : (
                            <Image
                    ...
                    <div className='logo-white' style={{ padding: '.25rem' }}>
                      <Link href='/'>
                        <a>
                          <Image
                            height={imageSize}
                 ...
                 <div className="col-xxl-6 col-xl-7 col-lg-7 d-none d-lg-block">
                  ...
                  <div className="tpmenu" style={{display: 'flex', alignItems:'center',  justifyContent: 'center'}}>
                    <p style={{fontSize: titleSize}} className='tpdesign-sub-title'>Maria Paez</p>
                     {/*
                    <nav id="mobile-menu">
                      <ul>
